...
public interface RestV3 extends Communication {
	...
	String transactionQuery(Credential credential, Long transactionNumber) throws ClientProtocolException, IOException;

	String transactionQuery(Credential credential, String storeCode, Long transactionNumber)
			throws ClientProtocolException, IOException;

	String transactionCapture(Credential credential, Long transactionNumber, Long value)
			throws ClientProtocolException, IOException;

	String transactionCapture(Credential credential, String storeCode, Long transactionNumber, Long value)
			throws ClientProtocolException, IOException;

	String transactionCancel(Credential credential, Long transactionNumber, Long value)
			throws ClientProtocolException, IOException;
	...
	String oneClickRegisterUpdate(Credential credential, String token, OneClickRegisterData registerData)
			throws ClientProtocolException, IOException;
	...
	String recurringPaymentQuery(Credential credential, Long recurringPaymentNumber)
			throws ClientProtocolException, IOException;

	String recurringPaymentQuery(Credential credential, String storeCode, Long recurringPaymentNumber)
			throws ClientProtocolException, IOException;

	String recurringPaymentCancel(Credential credential, Long recurringPaymentNumber)
			throws ClientProtocolException, IOException;
