...
public class RecurringPaymentTest {
	...
	public void testToJson() {
		RecurringPayment recurring = RecurringPayment.getBuilder(credential, 170, 2L, 130_00L)
				.withFrequency(RecurringPayment.Frequency.MONTHLY).withNotificationUrl("http://test.com/hook")
				.withProcessImmediately().withBillingAmount(0).withBillingFirstDate("08/09/2022")
		...
		assertEquals(
				"{\"recorrencia\":{\"formaPagamento\":170,\"numeroRecorrencia\":2,\"valor\":13000,\"modalidade\":1,\"periodicidade\":3,\"urlNotificacao\":\"http://test.com/hook\",\"processarImediatamente\":true,\"quantidadeCobrancas\":0,\"dataPrimeiraCobranca\":\"08/09/2022\",\"dadosCartao\":{\"nomePortador\":\"TEST BUYER\",\"numeroCartao\":\"4444333322221111\",\"codigoSeguranca\":\"123\",\"dataValidade\":\"01/2023\"},\"dadosCobranca\":{\"nomeComprador\":\"Test Buyer\",\"emailComprador\":\"common@email.com\",\"tipoCliente\":1,\"documento\":\"91234567890\",\"codigoCliente\":1,\"telefone\":{\"ddi\":\"55\",\"ddd\":\"11\",\"telefone\":\"35440500\",\"tipoTelefone\":1}}},\"estabelecimento\":\"4223161508040\"}",
				recurring.toJson());
	}
