...
public class TransactionTest {
	...
	public void setUp() {
		...
		credential.setUser("yapay_usr_test");
		credential.setPassword("yapay_pwd_test");
		credential.setStoreCode("4223161508040");
	}
	...
	public void testToJsonRegularPunctualAuthorization() {
		Transaction authorization = Transaction.getBuilder(credential, 170, 333L, 60_60L).addItem("Umbrella", 3, 20_00L)
				...
				.addChargingPhone("11", "35440500").withCard("TEST BUYER", "4444333322221111", "12/2022", "123")
				.build();
