<?php 
	...
	class RestV3 {
		...
		public function transactionAuthorize($credential, $transaction){
			$curl = $this->curlInit("POST", $baseUrl."/api/v3/transacao", $transaction, $credential);
		...
		public function transactionQuery($credential, $storeCode, $transactionNumber){
			$curl = $this->curlInit("GET", $baseUrl."/api/v3/transacao/".$storeCode."/".$transactionNumber, null, $credential);
			$response = curl_exec($curl);
			curl_close($curl);
			return $response;
		}
		...
		public function transactionCapture($credential, $storeCode, $transactionNumber, $value){
			$curl = $this->curlInit("PUT", $baseUrl."/api/v3/transacao/".$storeCode."/".$transactionNumber, null, $credential);
			$response = curl_exec($curl);
			curl_close($curl);
			return $response;
		}
		...
		public function oneclickRegister($credential, $oneclickRegisterData){
			$curl = $this->curlInit("POST", $baseUrl."/api/v3/oneclick/", $oneclickRegisterData, $credential);
			$response = curl_exec($curl);
			curl_close($curl);
			return $response;
		}
		...
		public function oneclickQuery($credential, $token){
			$curl = $this->curlInit("GET", $baseUrl."/api/v3/oneclick/".$token, null, $credential);
			$response = curl_exec($curl);
			curl_close($curl);
			return $response;
		}
		...
		public function oneclickRegisterUpdate($credential, $token, $oneclickRegisterData){
			$curl = $this->curlInit("PUT", $baseUrl."/api/v3/oneclick/".$token."/alterar", $oneclickRegisterData, $credential);
			$response = curl_exec($curl);
			curl_close($curl);
			return $response;
		}
		...
		public function oneclickAuthorize($credential, $token, $transaction){
			$curl = $this->curlInit("POST", $baseUrl."/api/v3/oneclick/".$token."/autorizar", $transaction, $credential);
			$response = curl_exec($curl);
			curl_close($curl);
			return $response;
		}
		...
		public function recurringPaymentRegister($credential, $recurringPaymentData){
			$curl = $this->curlInit("POST", $baseUrl."/api/v3/recorrencia", $recurringPaymentData, $credential);
			$response = curl_exec($curl);
			curl_close($curl);
			return $response;
		}
		...
		public function recurringPaymentQuery($credential, $storeCode, $recurringPaymentNumber){
			$curl = $this->curlInit("GET", $baseUrl."/api/v3/recorrencia/".$storeCode."/".$recurringPaymentNumber, null, $credential);
			$response = curl_exec($curl);
			curl_close($curl);
			return $response;
		}
		...
		public function recurringPaymentCancel($credential, $storeCode, $recurringPaymentNumber){
			$curl = $this->curlInit("PUT", $baseUrl."/api/v3/recorrencia/".$storeCode."/".$recurringPaymentNumber, null, $credential);
			$response = curl_exec($curl);
			curl_close($curl);
			return $response;
		}
